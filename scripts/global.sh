...
PROJ_DIR="/home/yxy/LineFS" ### Project root directory path in x86 host.
SIGNAL_DIR="$PROJ_DIR/scripts/signals"
KERNFS_SIGNAL_DIR="$SIGNAL_DIR/kernfs"
FORMAT_SIGNAL_DIR="$SIGNAL_DIR/mkfs"
NIC_SRC_DIR="/home/yxy/LineFS" ### Path of the host directory that includes source code for NIC.
SIGNAL_DIR_ARM="$NIC_SRC_DIR/scripts/signals"
KERNFS_SIGNAL_DIR_ARM="$SIGNAL_DIR_ARM/nicfs"

## Set paths in ARM.
NIC_PROJ_DIR="/home/yxy/LineFS" ### Project root directory path in SmartNIC.
...
HOST_1_INF="yxy@192.168.200.52"
HOST_2_INF="yxy@192.168.200.53"
...
NIC_1_INF="yxy@192.168.200.152"
NIC_2_INF="yxy@192.168.200.153"
